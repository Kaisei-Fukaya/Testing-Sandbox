...
[CustomEditor(typeof(TestingStyleTransfer))]
public class TestingStyleTransferEditor : Editor
{
    TestingStyleTransfer _target;

    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();

        if (!_target) { _target = (TestingStyleTransfer)target; }
